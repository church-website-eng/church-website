  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="flex h-8 w-8 items-center justify-center rounded-full bg-black text-white transition hover:scale-110"
      ...
      <button
        onClick={copyLink}
        className="flex h-8 w-8 items-center justify-center rounded-full bg-muted-light text-foreground/70 transition hover:scale-110 hover:bg-muted"
